...
public class SettingsActivity extends PreferenceActivity {
	...
	private void setupSimplePreferencesScreen() {
		...
		Preference button = (Preference)findPreference("button_logout");
		button.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
		                @Override
		                public boolean onPreferenceClick(Preference arg0) { 
		                	//Toast.makeText(SettingsActivity.this, "Button click", Toast.LENGTH_LONG).show();
		...
		bindPreferenceSummaryToValue(findPreference(Constants.SYNC_FREQUENCY));
		...
		listener = new SharedPreferences.OnSharedPreferenceChangeListener() {
		  public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
		    // Your Implementation
			  if(key.equals(Constants.SYNC_FREQUENCY)){
				  Log.d(TAG, "onSharedPreferenceChanged key=" + key);
				  Log.d(TAG, "onSharedPreferenceChanged value =" + prefs.getString(key, null));
	...
	public class UserLogoutTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPostExecute(final Boolean success) {
			if (success) {
				...
				broadcastIntent.setAction(Constants.LOGOUT_INTENT_FILTER);
